...
(function (global) {
  ...
  var ACTION_TITLES = {
    ...
    password_changed: '修改密码', password_change: '修改密码', password_reminder_set: '安排改密提醒', password_reminder_dismissed: '跳过改密提醒', permission_set: '更新设备权限', permission_granted: '授予设备权限', permission_revoked: '撤销设备权限', permission_updated: '更新设备权限',
  ...
  var ACTION_TITLES_EN = {
    ...
    password_changed: 'Change password', password_change: 'Change password', password_reminder_set: 'Schedule password reminder', password_reminder_dismissed: 'Dismiss password reminder', permission_set: 'Update device access', permission_granted: 'Grant device access', permission_revoked: 'Revoke device access', permission_updated: 'Update device access',
