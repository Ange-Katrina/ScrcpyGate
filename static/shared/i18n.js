...
(function () {
  ...
  var EN = {
    ...
    "待下次登录提醒": "Scheduled for next sign-in",
    "未设置": "Not scheduled",
    "设备与配置": "Devices and configurations",
    "设备权限": "Device access",
    "ALAS 配置": "ALAS configurations",
    "未授权设备": "No authorized devices",
    "未关联配置": "No linked configurations",
    "登录与投屏": "Sign-in and mirroring",
    "累计时长": "Total duration",
    "上次投屏": "Last mirroring session",
    "建议修改初始密码": "Change your initial password",
    "为保护账户，请设置仅你知道的新密码；也可以稍后再说。": "Protect your account with a password only you know. You can do this later.",
    "现在修改": "Change now",
    "稍后再说": "Later",
    "已跳过密码提醒": "Password reminder dismissed",
    "等待数据": "Waiting for data",
    "等待数据 · 每页 12 条": "Waiting for data · 12 per page",
    "正在加载": "Loading…",
    "设备接口返回后显示在线状态": "Online status appears after the device request completes",
    "会话接口返回后显示实时连接": "Live connections appear after the session request completes",
    "ALAS 接口返回后显示服务状态": "Service status appears after the ALAS request completes",
    "告警接口返回后显示待处理事项": "Pending items appear after the alert request completes",
    "等待设备接口数据": "Waiting for device data",
    "等待会话接口数据": "Waiting for session data",
    "等待告警接口数据": "Waiting for alert data",
    "日志队列等待数据": "Waiting for log queue data",
    "等待活动接口数据": "Waiting for activity data",
    "等待数据服务": "Waiting for data service",
    "未选择预设": "No preset selected",
    "正在加载审计风险统计": "Loading audit risk statistics",
    "等待服务端分页数据": "Waiting for paginated server data",
    "导出": "Export",
    "国家/地区": "Country/region",
    "状态码": "Status code",
    "拦截原因": "Block reason",
    "拒绝原因": "Denial reason",
    "投屏记录": "Mirroring record",
    "实时事件时间线": "Live event timeline",
    "未选择": "Not selected",
    "选择配置后查看运行状态": "Select a configuration to view its runtime status",
    "ALAS 数据已同步": "ALAS data synchronized",
    "到期提醒说明": "Expiry reminder help",
    "到期处理": "On expiry",
    "自动停止 ALAS 说明": "ALAS auto-stop help",
    "账户到期且会话与控制锁被回收时，仍在运行的关联 ALAS 配置会自动停止。": "When an account expires and its session and control lease are revoked, its linked running ALAS configurations stop automatically.",
    "设备列表说明": "Device list help",
    "按名称或 ADB 地址搜索，再按连接和投屏状态筛选设备。": "Search by name or ADB address, then filter by connection and mirroring state.",
    "API Token 保存说明": "API Token saving help",
    "已保存的 Token 不会回显；输入新值并保存可更新，留空则保持不变。": "Saved tokens are not shown. Enter and save a new value to replace the token, or leave it blank to keep the current one.",
    "日志保存时长说明": "Log retention help",
    "「不清理」仅关闭按天清理，行数与文件轮转上限仍生效。审计日志会保留校验链，运行日志只清理超期轮转段。": "Never only disables age-based cleanup. Row and rotation limits still apply. Audit logs retain their integrity chain; runtime logs remove only expired rotations.",
    "输出尺寸说明": "Output size help",
    "按最长边限制编码尺寸，保留设备比例；实际尺寸由设备编码器决定。": "Limits encoding by the longest edge while preserving the device aspect ratio. The encoder determines the actual output size.",
    "帧率说明": "Frame rate help",
    "帧率上限；日常建议 30 fps，游戏可尝试 60 fps。实际帧率取决于画面、设备和网络。": "Frame rate limit. Use 30 fps for everyday viewing or try 60 fps for games. Actual frame rate depends on content, device and network.",
    "地区库选择说明": "GeoIP database help",
    "投屏管理说明": "Workbench settings help",
    "访问权限请在「用户与权限」中管理。": "Manage access permissions in Users and permissions.",
    "先选择角色，再调整对应工作台的状态条、控制按钮与全屏显示。": "Select a role, then adjust its status bar, controls and fullscreen options.",
