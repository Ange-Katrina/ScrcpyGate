...
(function () {
  ...
  var EN = {
    ...
    "允许的国家或地区代码": "Allowed country or region codes",
    "点击用户卡片查看登录与投屏详情。": "Select a user card to view login and mirroring activity.",
    "用户详情": "User details",
    "累计投屏时长": "Total mirroring time",
    "投屏次数": "Mirroring sessions",
    "最近投屏开始": "Last mirroring start",
    "最近投屏结束": "Last mirroring end",
    "当前投屏连接": "Active mirroring connections",
    "最近投屏记录": "Recent mirroring activity",
    "登录记录": "Login history",
    "展开后加载最近登录记录": "Expand to load recent logins",
    "正在加载登录记录…": "Loading login history…",
    "登录记录加载失败，请收起后重试": "Could not load login history. Collapse and retry.",
    "保留期内暂无登录记录": "No login records within the retention period",
    "仅显示最近 20 条登录记录": "Showing only the 20 most recent logins",
    "IP 未记录": "IP not recorded",
    "删除库": "Delete database",
    "删除地区库": "Delete GeoIP database",
    "将删除所选地区库及其备份：": "Delete this GeoIP database and its backup:",
    "删除无法撤销。强制执行时不能删除正在使用的库；下载选项保持不变，仍勾选此类型时后续更新会重新下载。": "Deletion cannot be undone. An active database cannot be deleted in enforce mode. Download selections stay unchanged; a selected edition will be downloaded again on a later update.",
    "正在删除地区库…": "Deleting GeoIP database\u2026",
    "地区库及其备份已删除。": "The GeoIP database and its backup have been deleted.",
    "地区库已移除，部分恢复文件未能清理，请检查数据目录权限。": "Database removed, but some recovery files could not be cleaned up. Check data directory permissions.",
    "正在强制执行地域限制，请先切换为观察或关闭模式并保存，再删除正在使用的库。": "GeoIP restrictions are enforced. Switch to observe or off mode and save before deleting the active database.",
    "该地区库已不存在，请刷新列表。": "This database no longer exists. Refresh the list.",
    "地区库路径异常，未执行删除。": "Unsafe database path. Nothing was deleted.",
    "文件操作失败，请检查数据目录权限后重试。": "File operation failed. Check data directory permissions and retry.",
    "状态保存失败，地区库未删除。": "State could not be saved. The database was not deleted.",
    "恢复原库失败，请检查数据目录中的 .recovery 文件并手动恢复。": "Could not restore the original database. Check the .recovery files in the data directory and restore manually.",
    "仅有备份": "Backup only",
    "ALAS 配置运行情况": "ALAS configuration status",
    ...
    "登录或权限已失效，请刷新页面": "Session or permission expired. Refresh the page.",
    "设备已不存在，请刷新列表": "Device no longer exists. Refresh the list.",
    "刷新状态": "Refresh status",
    "不可用": "Unavailable",
    "内存": "Memory",
    "启动中": "Starting",
    "停止中": "Stopping",
    "{0} 个配置 · {1} 个运行中": "{0} configs · {1} running",
    "部分状态不可用，请重试": "Some statuses are unavailable. Retry.",
    "暂无 ALAS 配置": "No ALAS configurations",
    "状态获取失败，请重试": "Unable to load status. Retry.",
    "设备资源（按需刷新）": "Device resources (refresh on demand)",
    "设备资源：展开后自动刷新": "Device resources: auto-refresh while expanded",
    "展开时每 15 秒自动刷新，再次点击收起": "Refreshes every 15 seconds while expanded; click again to collapse",
    "CPU 温度": "CPU temp",
    "设备未提供温度时显示不可用": "Unavailable when the device does not expose a readable CPU sensor",
    "正在采样…": "Sampling…",
    "采样繁忙，请稍后重试": "Sampling is busy. Retry shortly.",
    "采样于": "Sampled at",
    "设备未提供部分指标": "Some metrics are unavailable on this device",
    "上次检查：": "Last checked: ",
    " · 缓存结果": " · cached",
    "检查失败": "Check failed",
    "无法连接镜像仓库。检查服务器网络后重试；不会修改当前服务。": "Cannot reach the image registry. Check server connectivity and retry; the running service is unchanged.",
    "此通道暂无镜像": "No image in this channel",
    "此通道尚无已发布镜像，可选择其他通道检查。提交源码不代表镜像已经发布。": "No published image was found for this channel. Try another channel; a source commit does not mean an image is published.",
    "当前版本领先": "Current version is ahead",
    "当前运行版本高于此通道的已发布版本，无需降级。": "The running version is newer than this channel’s release. No downgrade is needed.",
    "有可用更新": "Update available",
    "镜像已发布。复制下方命令，在服务器原部署目录执行更新。": "The image is published. Copy the command below and run it in the existing server deployment directory.",
    "版本号一致": "Versions match",
    "当前版本与此通道发布版本一致。若需重新拉取，可使用下方命令。": "The running version matches this channel’s release. Use the command below if you need to pull it again.",
    "可拉取验证": "Pull to verify",
    "这是会随发布变化的镜像标签，仅凭版本号无法确认是否需要更新。脚本拉取后会比较镜像，相同则跳过重建。": "This image tag changes with new builds, so a version number alone cannot confirm an update. The script pulls and compares images, skipping a rebuild when unchanged.",
    "接口未配置": "Endpoint not configured",
    "正在检查所选通道的已发布镜像…": "Checking published images in the selected channel…",
    "检查失败": "Check failed",
    "本次检查失败，请重试。旧更新命令已清除。": "This check failed. Retry to obtain a fresh update command.",
    "自动复制不可用，请选中命令手动复制。": "Automatic copy is unavailable. Select the command and copy it manually.",
    "命令已复制，请在服务器原部署目录执行。": "Command copied. Run it in the existing server deployment directory.",
    "版本状态与更新指引": "Version status and update guidance",
    "更新通道": "Update channel",
    "跟随当前部署": "Follow this deployment",
    "稳定版": "Stable",
    "开发版 · dev": "Development · dev",
    "主分支预览 · edge": "Main preview · edge",
    "当前运行版本": "Running version",
    "可用版本 / 标签": "Available version / tag",
    "正在读取版本信息…": "Reading version information…",
    "尚未检查": "Not checked",
    "查看发布记录": "View releases",
    "在服务器上更新": "Update on the server",
    "复制命令": "Copy command",
    "查看部署文档": "Deployment guide",
    "ALAS 自动更新": "ALAS automatic updates",
    "由 ALAS 自身管理": "Managed by ALAS",
    "适用于 deploy.sh 管理的 bridge 部署。进入原部署目录执行；脚本会先备份并保留回滚镜像，健康检查失败时尝试回滚。数据库迁移不会自动撤销。": "For bridge deployments managed by deploy.sh. Run in the existing deployment directory. The script backs up data, retains the previous image, and attempts rollback if health checks fail. Database migrations are not automatically reversed.",
    "完成后刷新本页并检查当前版本。host 网络或手动 Docker 部署请按部署文档更新。": "Refresh this page afterward and check the running version. For host networking or manual Docker deployments, follow the deployment guide.",
    "官方 ALAS 支持定期检查和定时安装更新。ScrcpyGate 尚未读取这项配置，因此不能确认你的 ALAS 是否已启用。": "Official ALAS supports periodic checks and scheduled installation. ScrcpyGate does not read these settings and cannot confirm whether your ALAS has them enabled.",
    "启用启动时更新": "Update at startup",
    "检查间隔（分钟），0 表示关闭": "Check interval in minutes; 0 disables checks",
    "每日更新时刻，null 表示关闭": "Daily update time; null disables the schedule",
    "允许更新后自动重启": "Allow automatic restart after updating",
    "在 ALAS 的 config/deploy.yaml 中配置；定时更新需要可写的源码目录、Git 和依赖安装权限，时间以 ALAS 所在环境为准。更新时会停止并恢复正在运行的实例。": "Configure config/deploy.yaml in ALAS. Scheduled updates require writable source files, Git, and permission to install dependencies. The schedule uses the ALAS environment’s clock. Running instances are stopped and resumed during updates.",
    "打开 ALAS 管理界面": "Open ALAS management",
    "官方配置说明": "Official configuration reference",
    ...
    "目标码率": "Target bit rate",
    "应用画质": "Apply quality",
    "请填写有效的画质参数": "Enter valid quality parameters",
    "参数已修改，点击应用画质": "Unsaved changes. Click Apply quality.",
    "实测接收帧率；静止画面会自动降低帧率，不代表卡顿": "Received frame rate. Static screens naturally use fewer frames; low FPS alone does not indicate lag.",
    "尺寸按长边上限缩放，保持设备比例；帧率为上限，静止画面会降低帧率。建议先选 30 fps，游戏可尝试 60 fps；卡顿时先降低分辨率或码率。": "The long-edge limit preserves the device aspect ratio. FPS is a limit; static screens use fewer frames. Start with 30 fps or try 60 fps for games. Reduce resolution or bit rate if playback stalls.",
    "预设一键应用；手动参数需点击应用画质。修改编码参数可能短暂重启共享视频流。": "Presets apply immediately. Click Apply quality after manual edits. Encoding changes may briefly restart the shared stream.",
    "帧率上限，实际帧率随画面变化。日常建议 30 fps，游戏可尝试 60 fps；更高帧率需要设备和网络支持": "Frame-rate limit; actual FPS varies with screen content. Start with 30 fps or try 60 fps for games. Higher rates require device and network support.",
    "目标编码码率，实际用量随画面变化；每个观看端分别占用上行带宽，建议预留余量": "Target encoding bit rate; actual usage varies with content. Each viewer consumes upload bandwidth, so leave headroom.",
    "按最长边限制编码尺寸，保留设备比例；宽高仅作参考，实际尺寸由设备编码器决定": "Limit the longest edge while preserving the device aspect ratio. Width and height are illustrative; the encoder determines the actual size.",
    "最近开始": "Last started",
    "累计观看 / 最近开始": "Total watch time / last start",
    "时间按浏览器本地时区显示。上次登录仅记录账号认证成功，不是打开页面的时间；观看时长按视频连接累计，多端同时观看分别计时，刷新或重连会新增次数。": "Times use your browser time zone. Last login records successful authentication, not page visits. Watch time sums retained video connections; simultaneous viewers count separately, and refreshes or reconnects add sessions.",
    "审计设备": "Audit device",
    "结果过多，请缩小时间范围后导出": "Too many results. Narrow the time range before exporting.",
    "运行日志仅筛选最近最多 2000 条；查找用户与设备操作请使用审计记录，或导出完整日志。": "Runtime filters cover at most the latest 2,000 entries. Use audit records for user and device actions, or export all retained logs.",
    "更新来源": "Update source",
    ...
    "数据库类型": "Database type",
    "选择数据库文件": "Choose a database file",
    "校验并启用": "Validate and activate",
    "先检查类型、构建时间、大小和 SHA-256；相同内容不重复替换。更新前保留一份旧库备份，失败时继续使用原库。": "Checks type, build date, size and SHA-256. Identical content is not replaced. Keeps one previous database as a backup and preserves it if activation fails.",
    "City · 国家、省份与城市": "City · Country, region and city",
    "Country · 仅国家": "Country · Country only",
    "已安装地区库": "Installed databases",
    "当前库大小": "Active database size",
    "库大小": "Database size",
    "构建时间": "Build date",
    "更新时间": "Updated at",
    "备份占用": "Backup size",
    ...
    "服务器文件": "Server file",
    "可在线下载或手动上传": "Download online or upload a file",
    "请选择 .mmdb 或官方 .tar.gz 文件。": "Choose an .mmdb or official .tar.gz file.",
    "文件为空或超过上传大小限制。": "The file is empty or exceeds the upload limit.",
    "正在上传并校验，请勿关闭页面…": "Uploading and validating. Keep this page open…",
    "内容校验一致，未重复替换或增加备份": "Content matches; no replacement or extra backup needed",
    "手动上传的地区库已启用": "Uploaded database activated",
    "文件不是有效的 MMDB 数据库。": "This file is not a valid MMDB database.",
    "所选类型与文件中的数据库类型不一致。": "The selected edition does not match the file.",
    "地区库已过期或构建时间异常，请上传近期发布的库。": "The database is expired or has an invalid build date. Upload a recent release.",
    "上传的数据库比当前版本旧，请选择较新的库。": "The uploaded database is older than the installed version. Choose a newer release.",
    "压缩文件无法读取，请选择官方 tar.gz 文件。": "Cannot read this archive. Choose an official tar.gz file.",
    "压缩包中未找到所选类型的数据库。": "The archive does not contain the selected database edition.",
    "文件长度不一致，请重新上传。": "File size mismatch. Upload the file again.",
    "已有地区库任务运行中，请完成后重试。": "A database task is already running. Try again after it finishes.",
    "上传超时，请检查网络后重试。": "Upload timed out. Check the connection and try again.",
    "下载文件大小与服务器声明不一致，原有地区库保留。": "Download size does not match the server response. The current database is preserved.",
    "下载文件校验值不一致，原有地区库保留。": "Download checksum mismatch. The current database is preserved.",
    "验证耗时预估": "Estimated verification time",
    "测一下这台设备完成验证大约需要多久。手机或较慢设备可能耗时更长，每次结果会有波动。": "Estimate how long verification takes on this device. Phones and slower devices may take longer; individual results vary.",
    "点击「开始试算」，查看当前难度在这台设备上的预计等待时间。": "Select Start benchmark to estimate the wait time for the current difficulty on this device.",
    "首次验证": "First verification",
    "连续失败后（难度上限）": "After repeated failures (maximum difficulty)",
    "约": "About",
    "这是本机性能估算，不是每次验证的保证时间；不会修改当前设置。": "This is a local performance estimate, not a guaranteed time. Your settings are unchanged.",
    "当前浏览器无法试算，请使用支持 Web Crypto 的浏览器。": "Benchmark unavailable. Use a browser with Web Crypto support.",
    "试算失败，请重试。": "Benchmark failed. Try again.",
    ...
    // 文本输入：中文/表情经设备剪贴板 + 粘贴键送达（scrcpy 的文本注入只支持键盘布局里有的字符）。
    '文本输入': 'Text input', '文本输入（中文与表情）': 'Text input (CJK and emoji)',
    '实体键盘输入方式': 'Physical keyboard input mode',
    '本机输入法（推荐）': 'Local input method (recommended)',
    '设备输入法（类似 QtScrcpy）': 'Device input method (like QtScrcpy)',
    '本机选好中文后发送；手机输入框需支持粘贴。': 'Compose text locally, then send it. The device field must support paste.',
    '关闭此窗口后点击投屏，用电脑英文键盘输入拼音，在手机端选词。手机需启用兼容的输入法；下方文本框仍按整段文本发送。': 'Close this dialog and click the mirrored screen. Use an English keyboard layout to type pinyin and select candidates on the device. A compatible device input method is required. The text box below still sends complete text.',
    '键盘输入方式已切换': 'Keyboard input mode changed',
    '无效的键盘输入方式': 'Invalid keyboard input mode',
    '设备输入法模式需要电脑实体键盘': 'Device input mode requires a desktop physical keyboard',
    '恢复自动方向': 'Restore automatic orientation', '已恢复自动方向': 'Automatic orientation restored',
    '音量增加': 'Volume up', '音量降低': 'Volume down',
    '关闭设备屏幕': 'Turn device screen off', '点亮设备屏幕': 'Turn device screen on', '继续投屏': 'Keep mirroring',
    '控制设备已变化，请重新获取控制权': 'The control target changed. Acquire control again.',
    '控制通道不可用，请重新获取控制权': 'The control channel is unavailable. Acquire control again.',
    '控制指令未发送，请检查控制连接': 'The command was not sent. Check the control connection.',
    '控制指令已发送，请确认设备响应': 'Command sent; check the response on your device',
    '中文与表情经设备剪贴板粘贴到光标处': 'CJK text and emoji are pasted at the cursor through the device clipboard',
    '用系统输入法打字或粘贴，回车发送': 'Type with your system input method or paste, then press Enter to send',
    '设备当前输入框需支持粘贴；纯英文与数字按普通按键输入，更兼容。': 'The focused field on the device must support paste. Plain ASCII is still sent as key input for better compatibility.',
    '要发送到设备的文本': 'Text to send to the device',
    '发送文本': 'Send text', '正在发送…': 'Sending…', '文本已发送': 'Text sent',
    '文本已发送到控制通道，请确认设备输入结果': 'Text sent to the control channel; check the result on your device',
    '控制通道不可用，文本未发送': 'The control channel is unavailable; text was not sent',
    '文本过长，请分次发送（每次最多 4096 UTF-8 字节）': 'Text is too long. Send it in separate batches of up to 4096 UTF-8 bytes.',
    '中文、表情及多行文本会覆盖设备剪贴板，输入框需支持粘贴。每次最多 4096 UTF-8 字节（约 1365 个常用汉字）；Shift+Enter 换行。': 'CJK, emoji, and multiline text replace the device clipboard and require a field that supports paste. Limit: 4096 UTF-8 bytes per send (about 1365 common CJK characters). Shift+Enter adds a new line.',
    '请输入要发送的文本': 'Enter the text to send', '中文': 'CJK',
    '控制输入不可用': 'Control input is unavailable', '请先获取控制权': 'Take control first',
    ...
    '已停止': 'Stopped', '检查中': 'Checking', '已禁用': 'Disabled', '已断开': 'Disconnected', '不可达': 'Unreachable', '配置无效': 'Invalid config', '未检查': 'Not checked', '未绑定': 'Not bound',
    '启动 ALAS': 'Start ALAS', '停止 ALAS': 'Stop ALAS', '重启 ALAS': 'Restart ALAS', 'ALAS 未绑定': 'No ALAS config bound',
    '状态获取失败': 'Could not retrieve status',
    'ALAS 状态已同步': 'ALAS status synchronized',
    '展开状态栏与控制栏': 'Show status and controls',
    '收起状态栏与控制栏': 'Hide status and controls',
    '操作已提交 · ALAS 状态已刷新': 'Operation submitted · ALAS status refreshed',
    '操作已提交 · 运行时仍在同步': 'Operation submitted · runtime is still synchronizing',
    '（运行时默认配置，未单独绑定该设备）': ' (runtime default; not bound to this device)',
    ...
    '修改后点击应用画质': 'Click Apply quality after editing',
